...
// const Container = {
//   template: '<canvas @click="applyDark()" id="myCanvas" width="400" height="400" style="border:1px solid #000000;"></canvas>',
...
// tozti.addRoutes([
//  { path: '/night', component: Container }
// ])

// tozti.addMenuItem("Life", "/life", { icon: 'nc-folder-15' })
